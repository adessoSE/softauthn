...
public class WebAuthnAuthenticatorBuilder {
    ...
    private Collection<AlgorithmID> supportedAlgorithms = EnumSet.allOf(AlgorithmID.class);
    ...
    public WebAuthnAuthenticatorBuilder supportAlgorithms(AlgorithmID... algorithms) {
        return supportAlgorithms(Arrays.asList(algorithms));
    }

    public WebAuthnAuthenticatorBuilder supportAlgorithms(Collection<AlgorithmID> supportedAlgorithms) {
